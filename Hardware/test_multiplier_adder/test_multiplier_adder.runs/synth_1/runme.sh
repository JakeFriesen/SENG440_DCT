...
HD_PWD='C:/Users/jakef/OneDrive/Documents/uvic/Summer 2022/SENG440/test_multiplier_adder/test_multiplier_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_multiplier.tcl
